...
build = {
  ...
  modules = {
    ...
    ["kong.plugins.log-buffering.lua_serializer"] = "kong/plugins/log-buffering/lua_serializer.lua",
    ...
    ["kong.plugins.galileo.serializer"] = "kong/plugins/galileo/serializer.lua",
